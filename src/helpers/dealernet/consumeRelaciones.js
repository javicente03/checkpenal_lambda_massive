...
const ConsumeSoapRelaciones = async (rut) => {
    ...
    <prods>
    <prod cod="3421" gls="Registros de Relacionados" />
    </prods>
    </root>
    </web:input>
    </web:CentralDeInformacion>
    ...
    // switch (rut) {
    //     case '15670634-5':
    //         data = fs.readFileSync('ortegaeduardorelaciones.xml', 'utf8');
    //         break;
    //     case '17546853-6':
    //         data = fs.readFileSync('romeromiguelrelaciones.xml', 'utf8');
    //         break;
    //     case '17324250-6':
    //         data = fs.readFileSync('pazyorrelaciones.xml', 'utf8');
    //         break;
    //     default:
