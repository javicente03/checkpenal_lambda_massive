...
const ConsumeSoapBoletinPenal = async (rut) => {
    ...
    <prods>
    <prod cod="3439" gls="Boletin de Procesos Penales" />
    </prods>
    </root>
    </web:input>
    </web:CentralDeInformacion>
    ...
    // switch (rut) {
    //     case '15670634-5':
    //         data = fs.readFileSync('ortegaeduardobolpenal.xml', 'utf8');
    //         break;
    //     case '17546853-6':
    //         data = fs.readFileSync('romeromiguelbolpenal.xml', 'utf8');
    //         break;
    //     case '17324250-6':
    //         data = fs.readFileSync('pazyorbolpenal.xml', 'utf8');
    //         break;
    //     default:
...
module.exports = ConsumeSoapBoletinPenal;